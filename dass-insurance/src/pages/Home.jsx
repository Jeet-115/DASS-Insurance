    ...
    <>
      ...
      <div className="bg-[#F9FAFB] text-[#1C2B33]">
          ...
          <div className="max-w-7xl mx-auto px-4 py-20 flex flex-col md:flex-row items-center z-10 relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl mb-8 opacity-90">
                Comprehensive solutions for health, vehicle, life, and business
                insurance.
              </p>
              <motion.div
        ...
        <section className="py-20 max-w-7xl mx-auto px-4 text-center">
          ...
          >
            At DASS Insurance, we help you secure your life, vehicles, and
            businesses. With years of experience and a customer-first approach,
            we’ve earned the trust of hundreds of clients.
          </motion.p>
          <Link
            to="/about"
        ...
        <section className="bg-[#1F2D3C] text-white py-20">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8">
              Call us now or get your free quote instantly.
            </p>
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
