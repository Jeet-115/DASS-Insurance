...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About DASS Insurance</title>
        <meta
          name="description"
          content="Learn about DASS Insurance, our mission, and how we provide reliable insurance solutions for individuals and businesses."
        />
      ...
      <div className="bg-slate-50 font-outfit">
        ...
        <section className="py-20 max-w-5xl mx-auto px-4">
          ...
          >
            DASS Insurance was started with a simple mission: to make insurance
          ...
          >
            We provide a wide range of services — from health and life insurance
            to vehicle and industrial coverage — so you can protect what matters
            most. Every policy is handled personally with care and attention.
          </motion.p>
        </section>
          ...
          <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-slate-600 mb-2">
                Hi, I’m <strong>Jeet Mistry</strong>, and I personally manage
                DASS Insurance. With years of experience and a passion for
                helping people, I guide each client to choose the best policy.
              </p>
              <p className="text-slate-600">
                When you work with us, you’re not just a policy number — you’re
                family.
              </p>
            </motion.div>
          </div>
        ...
        <section className="py-20 max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {[
              ...
              "Vehicle Insurance (Car, Bike, Bus)",
