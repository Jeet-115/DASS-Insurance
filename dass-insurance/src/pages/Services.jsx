    ...
    <>
      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto">
              Explore a wide range of customized insurance plans built to
              protect your health, assets, and future.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 max-w-5xl mx-auto px-4 text-center">
          ...
          >
            DASS Insurance provides reliable and comprehensive insurance plans
            to protect your lifestyle, your business, and your future.
          </motion.p>
        </section>
              ...
              {[
                {
                  ...
                  desc: "Covers damage, theft, and third-party liability for your two-wheeler.",
                },
                {
                  title: "Car Insurance",
                  desc: "Protection plans for both private and commercial cars with optional add-ons.",
                },
                {
                  title: "Bus Insurance",
                  desc: "Policies for private and commercial buses with driver and passenger cover.",
                },
                {
                  title: "Commercial Vehicles",
                  desc: "Insurance for taxis, trucks, goods carriers, tractors and more.",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <section className="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-16 text-center">
          ...
          <p className="mb-8 text-lg">
            Not sure which policy is right for you? We're happy to guide you
            personally.
          </p>
